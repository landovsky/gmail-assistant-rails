...
ActiveRecord::Schema[8.1].define(version: 2026_02_14_232500) do
  ...
  create_table "user_labels", primary_key: ["user_id", "label_key"], force: :cascade do |t|
  ...
  create_table "user_settings", primary_key: ["user_id", "setting_key"], force: :cascade do |t|
